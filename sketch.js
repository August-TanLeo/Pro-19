...
function preload(){
    ...
    mainRunnerImg1 = loadAnimation("mainRunner1.png", "mainRunner2.png", "mainRunner3.png", "mainRunner4.png");
    runner_collided = loadImage("runner_fallen-removebg-preview.png")
    
    villanImg1 = loadAnimation("villan1.png", "villan2.png", "villan3.png", "villan4.png", "villan5.png", "villan6.png", "villan7.png", "villan8.png", "villan9.png", "villan10.png", "villan11.png", "villan12.png");
 ...
 if(forest.x > 450){
  ...
  if (gameState===PLAY){
   ...
   if((touches.length > 0 || keyDown("space")) && runner.y>= 159){
    ...
    if(touches.length>0 || keyDown("SPACE") || mousePressesOver(restart)) {
      reset();
      touches = []
    }
  } 
